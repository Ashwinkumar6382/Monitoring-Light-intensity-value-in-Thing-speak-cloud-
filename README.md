...
include <WiFi.h>
 #include "ThingSpeak.h" // always include thingspeak header file after othe
 #define ldr_pin 34
 char ssid[] = "Shree";   // your network SSID (name) 
char pass[] = "1234";   // your network password
 int keyIndex = 0;            // your network key Index number (needed only f
 WiFiClient  client;
...
//display output on serial monitor
 ThingSpeak.writeField(myChannelNumber, ChannelField, lightPercentage, my
# CIRCUIT DIAGRAM:

![Screenshot 2025-01-02 142448](https://github.com/user-attachments/assets/eb906508-8ca0-4b53-b93e-eb337d5d5ac4)

# OUTPUT:

![Screenshot 2025-01-02 142502](https://github.com/user-attachments/assets/5249f730-322f-4811-854e-f97ad1dd819e)
